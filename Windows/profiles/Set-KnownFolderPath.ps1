...
.DESCRIPTION
	Run like
	Set-KnownFolderPath -KnownFolder 'Contacts' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Desktop' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Documents' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Downloads' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Favorites' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Links' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Music' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'My Safes' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Pictures' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Saved Games' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Searches' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Tracing' -Path 'D:\Users' -UserName "George"
	Set-KnownFolderPath -KnownFolder 'Videos' -Path 'D:\Users' -UserName "George"
#>
...
'@
	...
	$Path = $Path + "\"+$UserName +"\"+ $KnownFolder + "\"
    # Validate the path
    if (Test-Path $Path -PathType Container) {
        # Call SHSetKnownFolderPath
		write-host -f cyan "- Changing folder '$KnownFolder' to new location '$path'"
